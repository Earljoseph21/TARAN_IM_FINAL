    ...
    <body>
        ...
        $connection = mysqli_connect("localhost", "root", "","earlsdb");
            ...
            while($row=mysqli_fetch_assoc($result)){
                ...
                echo "<td>";
                    echo "<a class=\"btn\" href=\"editordersview.php?oid=".$row['Order ID']."\">edit</a>";
                    echo "<a class=\"btn\" href=\"deleteorders.php?oid=".$row['Order ID']."\" onclick=\"return confirm('Delete order?')\">delete</a>";
                echo "</td>";
                echo "</tr>";
             }
             $connection->close();
